...
setwd("C:/Users/danial/Desktop/eliminated variables/NN1Comb")  #set working folder
...
MyData = read.csv("dataNN1-comb.txt",header=TRUE)
MyData
...
i=0
while(i<250){
net.sum <- neuralnet(a,data=MyData,hidden=14,act.fct="logistic");
